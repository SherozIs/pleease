			...
			{ 2019,
			  4,
				...
				},
				{
					...
					{ "Теория Электрических Цепей", "Жаба", "20.06.19", { Diff, {.mark = Excel} }  },
...
struct ZACH* write2(void)
{
	...
	strcpy(Z2.firstName, "Геннадий");
	strcpy(Z2.lastName, "Иванович");
	strcpy(Z2.dadName, "Убийца");
	strcpy(Z2.number, "БИН1701");
